...
public class SkinConditionListAdapter1 extends RecyclerCommonAdapter<HealthGuidanceBean.DictsBeanX>  {
    ...
    public SkinConditionListAdapter1(AppCompatActivity context, List<HealthGuidanceBean.DictsBeanX> datas) {
        super(context, R.layout.item_depart_list, datas);
        mSinglePositions = new SparseBooleanArray();
    }

    @Override
    public void convert(ViewHolder holder, HealthGuidanceBean.DictsBeanX dictsBean, int position) {
