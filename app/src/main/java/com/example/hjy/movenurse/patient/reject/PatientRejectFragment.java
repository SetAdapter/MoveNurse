...
public class PatientRejectFragment extends BaseFragment {
    ...
    protected int getContentLayout() {
        return R.layout.fragment_patient_reject;
    }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.save_btn:
                JumpUtils.jump(mContext, PatientRejectActivity.class, null);
                break;
        }
    }
    ...
    private void getDepartList() {
        ...
        params.put("DictType", "10005");
        params.put("UserID", loginBean.getUserID());
        params.put("Token", loginBean.getToken());
        NetRequest.getInstens().requestDate(params, Api.getDicts10005, true, new NetCallBack<ArrayList<HealthGuidanceBean>>(mContext, R.string.data_loading) {
            @Override
