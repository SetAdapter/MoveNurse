...
public class NewbornNurseActivity extends BaseActivity {
    ...
    private void initInfoFragment(){
        ...
        NewbornNurseRecordFragment editFragment = new NewbornNurseRecordFragment();
