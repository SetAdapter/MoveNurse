...
/**
 * 已执行医嘱(处置医嘱 two) fragment
 * Created by fangs on 2017/9/21.
 */
public class OldDoctorTwoFragment extends BaseFragment {
        ...
        switch (view.getId()) {
            case R.id.tvDateSelect:
                DateSelectUtils.getDatePicker(mContext, date -> {
                    ...
                    String tvEndDateSelectText = tvEndDateSelect.getText().toString();
                    long endLong = TimeUtils.timeString2long(tvEndDateSelectText, "yyyy年MM月dd日");
    ...
    private void runRequest(){
        ...
        String startTime = tvDateSelect.getText().toString().trim() + " " + tvTimeSelect.getText().toString().trim();
        long current1 = TimeUtils.timeString2long(startTime, "yyyy年MM月dd日 HH:mm");
        ...
        params.put("OrderType", "1005201");//医嘱类型
        ...
        params.put("StartTime", TimeUtils.Long2DataString(current1, "yyyy-MM-dd HH:mm:ss"));//医嘱开始执行时间
    ...
    protected void showMenuPopup(View view){
        ...
        popupWindow = new CommonPopupWindow
                ...
                .setViewOnclickListener((view12, layoutResId) -> {
                    ...
                    tv1.setOnClickListener(OldDoctorTwoFragment.this);
                    tv2.setOnClickListener(OldDoctorTwoFragment.this);
                    tv3.setOnClickListener(OldDoctorTwoFragment.this);
