...
/**
 * 当前医嘱（药物医嘱 one） Fragment
 * Created by fangs on 2017/9/21.
 */
public class CurrentDoctorOneFragment extends BaseFragment{
    ...
    private void initRv(){
        ...
        adapter = new CurrentDoctorOneAdapter(mContext, data, "药物名称");
    ...
    private void runRequest(){
        ...
        params.put("OrderType", "1005206");//医嘱类型 药物
