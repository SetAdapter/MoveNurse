 ...
 * 压疮风险评估_编辑
 */
public class PressureSoresActivity extends BaseActivity {
    ...
    protected int getContentView() {
        return R.layout.pressure_sores_activity;
    }
    ...
    private void initInfoFragment() {
        ...
        PressureSoresRiskFragment editFragment = new PressureSoresRiskFragment();
