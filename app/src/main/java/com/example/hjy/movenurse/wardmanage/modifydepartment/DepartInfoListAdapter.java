 ...
 */
public class DepartInfoListAdapter extends RecyclerCommonAdapter<DepartBean.DictsBean> {
    ...
    public DepartInfoListAdapter(AppCompatActivity context, List<DepartBean.DictsBean> datas) {
        super(context, R.layout.item_depart_list, datas);
        mSinglePositions = new SparseBooleanArray();
    }

    @Override
    public void convert(ViewHolder holder, DepartBean.DictsBean dictsBean, int position) {
