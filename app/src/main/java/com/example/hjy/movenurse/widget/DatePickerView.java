...
public class DatePickerView extends View {
     ...
     * 滑动的距离
     */
    private static float mMoveLen = 0;
    private boolean isInit = false;
    private boolean canScroll = true;
    private onSelectListener mSelectListener;
    private Timer timer;
    private static MyTimerTask mTask;


    static class MyHandler extends Handler {
        WeakReference<DatePickerView> mActivity;
        MyHandler(DatePickerView activity) {
            mActivity = new WeakReference<>(activity);
        }
        @Override
        public void handleMessage(Message msg) {
            DatePickerView datePickerView = mActivity.get();
    ...
    MyHandler updateHandler = new MyHandler(this);
