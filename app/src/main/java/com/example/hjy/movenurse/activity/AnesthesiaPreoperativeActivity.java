 ...
 */
public class AnesthesiaPreoperativeActivity extends BaseActivity {
    ...
    protected int getContentView() {
        return R.layout.anesthesia_preoperative_activity;
    }
    ...
    private void initInfoFragment() {
        ...
        AnesthesiaPreoperativeCompilFragment editFragment = new AnesthesiaPreoperativeCompilFragment();
