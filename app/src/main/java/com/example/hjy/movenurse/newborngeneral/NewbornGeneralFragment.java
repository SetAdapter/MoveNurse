...
public class NewbornGeneralFragment extends BaseFragment {
    ...
    NewbornGeneralAdapter mAdapter;

    @Override
    protected int getContentLayout() {
        return R.layout.newborn_general;
    }
    ...
    private void initRv() {
        List<NewBornRecordBean> data = new ArrayList<>();
        ...
        mAdapter = new NewbornGeneralAdapter(mContext, data);
    ...
    private void getNursingRecodes() {
        ...
        NetRequest.getInstens().requestDate(params, Api.NeonatalCareRecodes1, false, new NetCallBack<ArrayList<NewBornRecordBean>>(mContext, R.string.loading_get) {
            @Override
            public void onSuccess(ArrayList<NewBornRecordBean> obj) {
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.tvEdit://编辑按钮
                JumpUtils.jump(mContext, NewbornGeneralActivity.class, null);
                break;
        }
    }
