...
public final class DaggerRequestComponent implements RequestComponent {
  ...
  private MembersInjector<RequestConn> requestConnMembersInjector;
  ...
  private void initialize(final Builder builder) {
    ...
    this.requestConnMembersInjector = RequestConn_MembersInjector.create(getServiceProvider);
  }

  @Override
  public void inJect(RequestConn requestConn) {
    requestConnMembersInjector.injectMembers(requestConn);
  }
