...
import com.fy.utils.ScreenUtils;
...
public class ImgPickersAdapter extends MultiItemCommonAdapter<ImageItem>{
    ...
    private ImgPickersAdapter(AppCompatActivity context, List<ImageItem> datas) {
        super(context, datas, new MultiItemTypeSupport<ImageItem>(){
            @Override
    ...
    static class Bulder{
        ...
        public ImgPickersAdapter create(AppCompatActivity context, List<ImageItem> datas){
