...
import com.fy.convenientbanner.ConvenientBanner;
import com.fy.convenientbanner.holder.CBViewHolderCreator;
...
public class PicturePreviewActivity extends BaseActivity {
    ...
    protected RelativeLayout rlHead;         //头部布局
    ...
    protected void init(Bundle savedInstanceState) {
        ...
        rlHead.setBackgroundColor(getResources().getColor(R.color.alphaHeadBg));
        viewPager = (ConvenientBanner) findViewById(R.id.bannerViewPager);
        tvTitle = (TextView) findViewById(fy.library.com.baselibrary.R.id.tvTitle);
        tvBack = (TextView) findViewById(fy.library.com.baselibrary.R.id.tvBack);
        tvMenu = (TextView) findViewById(fy.library.com.baselibrary.R.id.tvMenu);
